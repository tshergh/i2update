        ...
        return await msg.edit(
               ...
               reply_markup = InlineKeyboardMarkup(
                    [[InlineKeyboardButton("📢 ↓ بث ↓ 📢", callback_data="nabilanavab")],
                     ...
                     [InlineKeyboardButton("👤 ↓ بث ↓ 👤", callback_data="nabilanavab")],
                     [InlineKeyboardButton("🔸 نسخ 🔸", callback_data="send|copy|pm"),
                      InlineKeyboardButton("🔸 توجية 🔸", callback_data="send|forw|pm")
                    ]]
                ))
    ...
    try:
        ...
        if ___ == "broad":
            ...
            return await callbackQuery.message.edit(
                text = f"`اكتمال البت:`\n__اكتمل في__ {time_taken} __ثانية ⏰__\n\n"
                       f"__مجموع:__ {total_users} 😎\n__مكتمل:__   {done} / {total_users} 👑\n"
                       f"__بنجاح:__     {success} ✅\n__بلوك:__     {blocked} ❌\n"
                       f"__ميتين:__     {deleted} ⚰️\n\n",
                reply_markup = InlineKeyboardMarkup(
                    [[InlineKeyboardButton("🔸 كعادة توجية 🔸" if __=="forw" else "🔸 asCopy 🔸",
                        callback_data = "nabilanavab")
                    ]]
                ))
        elif ___ == "pm":
