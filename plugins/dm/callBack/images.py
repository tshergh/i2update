        ...
        if data in ["IA", "DA", "zipA", "tarA"]:
            ...
            while(nabilanavab):    # 5 EXCEPTION, BREAK MERGE PROCESS
                ...
                needPages = await bot.ask(
                    ...
                    reply_markup = ForceReply(True, "Ex: 7:86 [start:end|بداية:نهاية]")
        ...
        # SINGLE PAGES
            ...
            while(nabilanavab):    # 5 REQUEST LIMIT
                ...
                needPages = await bot.ask(
                    ...
                    filters = filters.text, reply_markup = ForceReply(True, "Eg: 7,8,6 [pages صفحات]")
                )
            ...
            with fitz.open(input_file) as doc:
                ...
                if data in ["IA", "DA", "IR", "DR"]:
                    ...
                    if data in ["zipA", "zipR", "tarA", "tarR"]:
                        await downloadMessage.edit(text = f"`إجمالي الصفحات: {end+1 - start}..⏳`", reply_markup=cancel)
                        totalPgList = range(start, end+1)
