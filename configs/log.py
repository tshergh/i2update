                ...
                if log.LOG_CHANNEL:
                    try:
                        ...
                        await bot.send_message(
                            ...
                            reply_markup = InlineKeyboardMarkup([[InlineKeyboardButton("✅ حظر مستخدم ✅", callback_data = f"banC|{message.chat.id}")]])
                        )
                        ...
                        try:
                            await bot.send_message(
                                ...
                                text = log.LOG_TEXT.format(message.from_user.id, message.from_user.mention) \
                                       + f"\nالمشار إليه من قبل : [{referID}](tg://user?id={referID})",
                                reply_markup = InlineKeyboardMarkup([[InlineKeyboardButton("✅ حظر مستخدم ✅", callback_data = f"banU|{message.from_user.id}")]])
                            )
                            return
