...
class images(object):
    ...
    THUMBNAIL_URL = "https://te.legra.ph/i2pdfbot-12-14-2"   # to inc. meadia edit speed
    
    # WELCOME IMAGE
    WELCOME_PIC = "https://te.legra.ph/i2pdfbot-12-14-2"  # WELCOME IMAGE
    
    # BANNED IMAGE
    BANNED_PIC = "https://te.legra.ph/i2pdfbot-12-14-2"
    
    # BIG FILE
    BIG_FILE = "https://te.legra.ph/i2pdfbot-12-14-2"
