...
To change the language click button at down
""",
    "HomeACB": {
        "⚙️ الإعدادات(.set)⚙️": "Home|B" , "⚠️ مساعدة ⚠️": "Home|C",
    ...
    "HomeAdminCB": {
        ...
        "📢 القناة 📢": f"{str(settings.OWNED_CHANNEL)}",
        "🌟 تقييم 🌟": f"{str(settings.SOURCE_CODE)}",
        "🗽 الحالة 🗽": "status|home", "🚶 أغلق 🚶": "close|mee"
    } ,
...
الإبهام: {} \n التسمية التوضيحية: {} \n اسم الملف: {} """,
    "HomeBCB": {
        "🌍 اللغة 🌍": "set|lang", "📍 ثيم 📍": "set|thumb",
        "📈 ألاسم 📈": "set|fname", "💩 API 💩": "set|api",
        "📅 التسمية التوضيحية 📅": "set|capt", " «الرئيسية« ": "Home|B2A"
    } ,
    "HomeC": """🪂 ** رسالة المساعدة **:
...
SETTINGS = {
    ...
    "wait": {"أنتظر .. 🥱": "nabilanavab"}, "back": {" «الرئيسية«": "Home|B2S"}, "errorCB": {" «الرئيسية« ": "Home|B2A"} ,
    ...
    "thumb" : [
        {"SETTING ⚙️» THUMBNAIL 📷 ":"nabilanavab"," ♻ أضف ♻ ":"set|thumb+"," «الرئيسية« ":"Home|B"},
        {"SETTING ⚙️» THUMBNAIL 📷 ":"nabilanavab"," ♻ تغيير ♻ ":"set|thumb+","  🗑حذف ":"set|thumb-"," « «الرئيسية« ":"Home|B2S"}
    ],
    "fname": [
        {"SETTإعداداتING ⚙️» FNAME 📷 ":"nabilanavab"," ♻ أضف ♻ ":"set|fname+"," «الرئيسية« ":"Home|B2S"},
        {"إعدادات ⚙️» FNAME 📷 ":"nabilanavab"," ♻ تغيير ♻ ":"set|fname+"," حذف 🗑 ":"set|fname-","  «الرئيسية« ":"Home|B2S"}
    ] ,
    "api": [
        {"إعدادات ⚙️» API 📷 ​​":"nabilanavab"," ♻ أضف ♻ ":"set|api+"," «الرئيسية« ":"Home|B2S"},
        {"إعدادات ⚙️» API 📷 ​​":"nabilanavab"," ♻ تغيير ♻ ":"set|api+"," 🗑 حذف 🗑 ":"set|api-","  «الرئيسية« ":"Home|B2S"}
    ] ,
    "capt": [
        {"الإعداد ⚙️» التسمية التوضيحية 📷":"nabilanavab"," ♻ أضف ♻ ":"set|capt+","  «الرئيسية« ":"Home|B2S"},
        {"الإعداد ⚙️» التسمية التوضيحية 📷":"nabilanavab"," ♻ تغيير ♻ ":"set|capt+","  🗑حذف ":"set|capt-"," «الرئيسية« ":"Home|B2S"}
    ]
}
...
البوت:i2pdfbotchannel 💎 \n [قناة الدعم] ({settings.OWNED_CHANNEL}) """,
    "CB": {"⚠️ أغلق ⚠️": "close|all"}
}
...
أشياء مع ملفات @ Telegram PDF \n \n شكرًالtaher على هذا الروبوت الرائع 😅 """,
    "HomeACB": {
        "🤠 مالك بوت 🤠": f"https://telegram.dog/{settings.OWNER_USERNAME}",
        "🛡️ قناة تحديثات 🛡️": f"{settings.OWNED_CHANNEL}", "🌟 تقييم 🌟": f"{settings.SOURCE_CODE}"
    }
}
...
BAN = {
    ...
    "banCB": {
        "تقييم": f"{settings.SOURCE_CODE}" , "البرنامج التعليمي": f"{settings.SOURCE_CODE}" ,
        "تحديث القناة": "https://t.me/i2pdfbot"
    } ,
...
👇👇👇👇
 @i2pdfbotchannel
""" ,
    "ForceCB": {"🌟 أنظم في قناة 🌟": "{}", "♻️ تحديث ♻️": "Refresh"},
    "Fool": "يجيب عليك انضمام اولاً 🤭"
}
...
checkPdf = {
    ...
    "pdfCB": {
        ...
        "🗜️ ضغط 🗜️": "work|compress", "🤸 تدوير 🤸": "pdf|rotate",
        "✂️ تقسيم ✂️": "pdf|split", "🧬 دمج 🧬": "merge", "™ ️ STAMP ™ ️": "pdf|stp",
        "✏️ إعادة تسمية ✏️": "work|rename", "📝 OCR 📝": "work|ocr",
         "🥷 تنسيق A4": "work|format", "🚫 أغلق 🚫": "close|all"
    } ,
    "error": """__ لا أفعل أي شيء بهذا الملف__ 😏 \n \n🐉` خطأ CODEC` 🐉 """,
    "errorCB": {"❌ ERROR IN CODEC ❌": "error", "🔸 أغلق 🔸": "close|all"},
    "encrypt": """` ملف مشفر` 🔐 \n \n اسم الملف: `{}` \n حجم الملف: `{}` """,
...
PROGRESS = {
    ...
    "dlFile": "` جارٍ تنزيل ملفك ..` 📥 ","upFileCB": {" 📤 .. تحميل .. 📤 ":" nabilanavab "},
    "workInP": "العمل قيد التقدم .. 🙇", "refresh": {"♻️ تحديث ♻️": "{}"},
    "takeTime": """`العمل جاري ...` \n` قد يستغرق بعض الوقت ...`""",
    "cbPRO_D": ["📤 DOWNLOAD(تنزيل): {: .2f}٪ 📤", "🎯 CANCEL(الغاء) 🎯"], "cbPRO_U": ["📤 UPLOADED(تحميل): {: .2f}٪ 📤", "🎯 CANCEL(الغاء) 🎯"]
}
...
GENERATE = {
    ...
    "geting": "اسم الملف:` {} `\n الصفحات:` {} `", "getingCB": {"📚 إنشاء ملفات PDF ..": "nabilanavab"},
...
\n` ارجوك ارسل لي ملف اقل من {} ميغا بايت الحجم` 🙃 """,
    ...
    "generate": {"إنشاء 📚": "إنشاء"} , "cancelCB": {"⟨أغلق⟩": "close|me"}
}
...
split = {
    ...
    "download": PROGRESS['dlFile'], "exit": "` تم إلغاء العملية ..` 😏 ",
    "button" : {
...
pdf2IMG = {
    ...
    "toImage": {
        "⚙️ PDF» صور ↓ ":"nabilanavab"," 🖼 صور 🖼 ":"pdf|img|img",
        "📂 ملف 📂": "pdf|img|doc", "🤐 ZIP 🤐": "pdf|img|zip" ,
        "🎯 TAR 🎯": "pdf|img|tar", "« عودة«": "pdf"
    } ,
    "imgRange": {
        "⚙️ PDF» صور »{} ↓": "nabilanavab", "🙄 الكل 🙄": "p2img|{}A",
        "🤧 RANGE 🤧": "p2img|{}R", "🌝 صفحات 🌝": "p2img|{}S", "« عودة«": "pdf|img"
    } ,
...
pdf2TXT = {
    ...
    "font_btn": {
        ...
        "Symbol": "pdf|font|s", "Zapfdingbats": "pdf|font|z", "🚫 أغلق 🚫": "close|me"
    } ,
