...
/delete: 清除图像到 pdf 队列\n/txt2pdf: 文本到 pdf""",
    "adminHelp" : """\n\n\n[管理命令消息]:\n
/send: 广播, pm message""",
    "footerHelp" : f"""\n\n\nRate: [I2pdf]({str(settings.SOURCE_CODE)})
...
@Telegram PDF 文件的事情\n\n感谢 @ta_ja199 这个 Awesome Bot 😅""",
    "HomeACB":{
        "🤠 BOT OWNER 🤠": f"https://telegram.dog/{settings.OWNER_USERNAME}",
        "🛡️ 更新频道 🛡️":f"{settings.OWNED_CHANNEL}","🌟 Rate 🌟":f"{str(settings.SOURCE_CODE)}"
    }
}
...
\n`请给我发送一个小于 {}mb Size` 的文件🙃""",
    "bigCB" : {"💎 创建 2Gb 支持机器人💎" : "https://t.me/i2pdfbotchannel"},
...
inline_query = {
    "TOP":{"现在 , 选择语言➟":"nabilanavab"},"capt":"SET LANGUAGE ⚙️","des":"作者:@ta_ja199 ❤"
}
